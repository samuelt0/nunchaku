...
transformer = NunchakuWanTransformer3DModel.from_pretrained(
    "/home/samuel/nunchaku/w4a4-wan2-high/merged.safetensors", offload=False, precision=precision
)  # set offload to False if you want to disable offloading
transformer_2 = NunchakuWanTransformer3DModel.from_pretrained(
    "/home/samuel/nunchaku/w4a4-wan2-low/merged.safetensors", offload=False, precision=precision
)  # set offload to False if you want to disable offloading
